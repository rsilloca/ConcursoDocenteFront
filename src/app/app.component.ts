...
export class AppComponent {
  ...
  constructor(private sidenavService: SidenavService,
    ...
    this.sidenavService.addItems([
      ...
      {
        name: 'Concursos',
        routeOrFunction: '/concursos',
        icon: 'fact_check',
        position: 20
      },
      {
        name: 'Plazas',
        routeOrFunction: '/plazas',
        icon: 'view_list',
        position: 25
      },
      {
        name: 'Postulantes',
        routeOrFunction: '/postulantes',
        icon: 'groups',
        position: 30
      },
      {
        ...
        subItems: [
          {
            name: 'Facultades',
            routeOrFunction: '/configuracion/facultades',
            position: 10
          },
          {
            name: 'Departamentos',
            routeOrFunction: '/configuracion/departamentos',
            position: 15
          },
          {
            name: 'Asignaturas',
            routeOrFunction: '/configuracion/asignaturas',
            position: 20
          }
        ]
      },
